module github.com/yeencloud/lib-base
...
require (
	...
	github.com/yeencloud/lib-database v0.1.0
	github.com/yeencloud/lib-httpserver v0.1.1
	github.com/yeencloud/lib-logger v0.1.1
	github.com/yeencloud/lib-logger-addon-zerolog v0.1.0
